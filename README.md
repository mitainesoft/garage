...
9. DESIGN ENV SETUP
    ...
    ** git config **
        git config --global user.name "<your_signum>" (e.g. lmcjecy, exxxxxx)
        git config --global user.email "<your_email_address>" (as it appears in Outlook, e.g. firstname.lastname@mitainesoft.com)
